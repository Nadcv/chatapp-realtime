...
- **📰 Notícias (ao vivo)** — Euronews em Português (🇵🇹), Euronews en Español (🇪🇸), France 24 (🇫🇷), via YouTube. Cada canal usa o endpoint público do YouTube que resolve sozinho "o que está em direto agora" naquele canal — não dependemos de um vídeo específico que muda a cada transmissão. Testei também a TVS (São Tomé e Príncipe), mas tal como a RTP/RTVE, não transmite mesmo pelo sistema de Live do YouTube ("vídeo não disponível") — parece ser comum entre televisões públicas pequenas, por isso tirei-a da lista.
