...
- **📰 Notícias (ao vivo)** — Euronews em Português (🇵🇹), Euronews en Español (🇪🇸), France 24 (🇫🇷), TVS — São Tomé e Príncipe (🇸🇹, YouTube e também o site oficial `tvs.st` como alternativa), TPA — Angola (🇦🇴), RTC — Cabo Verde (🇨🇻), TVM — Moçambique (🇲🇿), RTTL — Timor-Leste (🇹🇱), Record News (🇧🇷) e Record Europa (🇵🇹). A maioria usa o endpoint público do YouTube que resolve sozinho "o que está em direto agora" naquele canal — não dependemos de um vídeo específico que muda a cada transmissão.
  - **Nível de confiança desigual, por ser experimental:** confirmei que a Euronews, a France 24 e a Record News (encontrei "AO VIVO: Record News 24 horas de graça") emitem mesmo 24h pelo YouTube. Para os restantes canais lusófonos (TVS, TPA, RTC, TVM, RTTL, Record Europa) só encontrei o canal oficial deles — não consigo confirmar se realmente transmitem ao vivo pelo YouTube o dia todo (a RTTL parece a mais promissora, com um canal chamado literalmente "live streaming"). É normal alguns aparecerem "vídeo não disponível" fora dos horários em que estiverem mesmo a emitir, ou nunca funcionarem se não usarem o sistema de Live do YouTube — avisa-me quais funcionam e quais não, para eu ir ajustando.
