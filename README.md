...
- **Lista de reserva quando o Gutendex está em baixo**: o Gutendex é um serviço gratuito de terceiros, sem garantia de estar sempre disponível (já devolveu HTTP 503 em produção). Quando isso acontece, a Biblioteca nunca fica vazia — mostra sempre uma pequena lista fixa de clássicos em português (Os Lusíadas, Dom Casmurro, Memórias Póstumas de Brás Cubas, O Primo Basílio — IDs reais e verificados do Project Gutenberg), com um aviso claro de que não é o resultado da pesquisa/lista pedida.
