...
- **📊 Estatísticas de pesquisa** (secção própria) — cada pesquisa de voo (Ignav) feita com sessão iniciada fica registada (rota, data, preço mais barato encontrado); mostra o total de pesquisas, a rota mais pesquisada e o preço mais baixo que já viste. Só cobre voos (Ignav) — a pesquisa de comboio/autocarro (Tictactrip) usa identificadores internos da Tictactrip em vez de códigos legíveis, por isso não entra nas estatísticas por agora. Guardado em `travel-history.json`, últimas 100 pesquisas por pessoa.
