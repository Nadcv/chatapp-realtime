...
- **📰 Notícias (ao vivo)** — Euronews em Português (🇵🇹), Euronews en Español (🇪🇸), France 24 (🇫🇷), TVS — Televisão Santomense (🇸🇹), via YouTube. Cada canal usa o endpoint público do YouTube que resolve sozinho "o que está em direto agora" naquele canal — não dependemos de um vídeo específico que muda a cada transmissão. **Nota sobre a TVS:** ao contrário da Euronews/France24 (que emitem 24 horas por dia), estações pequenas como a TVS provavelmente só ficam "ao vivo" em horários específicos (ex.: noticiário) — por isso é normal aparecer "vídeo não disponível" fora desses horários; não é um erro da app nem significa que o canal esteja bloqueado.
