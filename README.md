...
- Escreve os códigos IATA de origem e destino (3 letras, ex.: `LIS`, `OPO`, `MAD`) e uma data, depois toca em "Pesquisar voos". Cada resultado tem um botão "🔗 Ver opções de reserva" que abre o link da companhia numa nova aba.
