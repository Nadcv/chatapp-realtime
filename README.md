...
- **📰 Notícias (ao vivo)** — Euronews em Português (🇵🇹), Euronews en Español (🇪🇸), France 24 (🇫🇷), TVS — São Tomé e Príncipe (🇸🇹, YouTube e também o site oficial `tvs.st` como alternativa), TPA — Angola (🇦🇴), RTC — Cabo Verde (🇨🇻), TVM — Moçambique (🇲🇿), RTTL — Timor-Leste (🇹🇱), Record News (🇧🇷), Record Europa (🇵🇹), TVG — Galiza (🇪🇸), DW Español (🇩🇪), TV Aparecida (🇧🇷) e El Doce — Córdoba, Argentina (🇦🇷). A maioria usa o endpoint público do YouTube que resolve sozinho "o que está em direto agora" naquele canal — não dependemos de um vídeo específico que muda a cada transmissão.
  - **Nível de confiança desigual, por ser experimental:** confirmei que a Euronews, a France 24, a Record News, a TVG, a DW Español e o El Doce emitem mesmo 24h pelo YouTube (encontrei "24 horas"/"24/7" nos títulos dos streams deles). A TV Aparecida também parece fiável (canal religioso com programação contínua). Para os restantes canais lusófonos (TVS, TPA, RTC, TVM, RTTL, Record Europa) só encontrei o canal oficial deles — não consigo confirmar se realmente transmitem ao vivo pelo YouTube o dia todo. É normal alguns aparecerem "vídeo não disponível" fora dos horários em que estiverem mesmo a emitir, ou nunca funcionarem se não usarem o sistema de Live do YouTube — avisa-me quais funcionam e quais não, para eu ir ajustando.
  - **"Bom Dia Moçambique"** não é um canal — é só um programa (telejornal da manhã) da própria TVM, já incluída na lista.
  - Não incluí a **RTVE Notícias** outra vez — é a mesma emissora que já tinha bloqueado a incorporação (foi por isso que troquei o canal de Espanha para a Euronews en Español, no início desta funcionalidade).
  - Não incluí a **TDM (Macau)** — não encontrei um canal de YouTube com confirmação de transmissão ao vivo, só o site próprio deles.
  - Não incluí a **TV Girassol** — encontrei o canal deles ("TV Girassol Online"), mas não consegui confirmar com segurança o ID exato do canal de YouTube; e a **TVOne** — não encontrei nenhum canal lusófono específico com esse nome. Manda-me o link se souberes qual é.
  - **Recusei adicionar** conteúdo infantil com direitos de autor válidos (PJ Masks, Miraculous, Blippi) que foi pedido a par destes canais — não há forma legal e gratuita de os disponibilizar, tal como já tinha explicado sobre a série "Mentalista".
